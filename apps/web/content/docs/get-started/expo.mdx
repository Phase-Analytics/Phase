...
<Tabs defaultValue="bun" groupId="pkg" persist>
  ...
  <TabsContent value="npm">
    <CodeBlock lang="bash" allowCopy={false}>
```bash
npx expo install @react-native-async-storage/async-storage expo-device expo-localization expo-router
```
    </CodeBlock>
  </TabsContent>
  <TabsContent value="bun">
...
```
  ...
  <TabsContent value="yarn">
    <CodeBlock lang="bash" allowCopy={false}>
```bash
yarn dlx expo install @react-native-async-storage/async-storage expo-device expo-localization expo-router
```
    </CodeBlock>
  </TabsContent>
  <TabsContent value="pnpm">
    <CodeBlock lang="bash" allowCopy={false}>
```bash
pnpm dlx expo install @react-native-async-storage/async-storage expo-device expo-localization expo-router
```
    </CodeBlock>
  </TabsContent>
</Tabs>
