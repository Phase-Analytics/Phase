...
- Category G - We do not store IP addresses. Geolocation data is derived transiently from IP addresses, limited to country or region level, and retained for up to 12 months
