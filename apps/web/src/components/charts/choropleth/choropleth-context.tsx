...
export type ChoroplethFeatureProperties = {
  name?: string;
  id?: string | number;
  [key: string]: unknown;
};
...
export type ChoroplethTooltipData = {
  featureIndex: number;
  x: number;
  y: number;
...
export type ChoroplethInteractionContextValue = {
...
export type ChoroplethStableContextValue = {
  // Geo data
