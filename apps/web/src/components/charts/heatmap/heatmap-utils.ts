...
export type HeatmapSeparatorParsedConfig = {
  groupBy: HeatmapSeparatorGroupBy;
  every?: number;
  spacing: number;
};

export type HeatmapSeparatorGroup = {
...
export type HeatmapSeparatorLayout = {
  spacing: number;
  atColumns: number[];
...
export type HeatmapSeparatorGradient = {
  from: string;
  via?: string;
  to: string;
  fromOpacity?: number;
...
export type HeatmapSeparatorGradientStop = {
  offset: string;
  color: string;
  opacity: number;
};
...
export type HeatmapHoverStyleParams = {
