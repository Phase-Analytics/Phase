  ...
  return (
    <div className="flex min-h-screen flex-col">
          ...
          <div className="grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <p className="text-md text-muted-foreground leading-relaxed sm:text-xl">
                Track user behavior, measure engagement, and optimize your
                product with real-time analytics that respects privacy.
              </p>
      ...
      <Footer
        ...
        socialLinks={[
          {
            href: 'https://cal.com/mirac',
            icon: <HugeiconsIcon icon={Call02Icon} size={20} />,
            label: 'SCHEDULE CALL',
          },
          {
