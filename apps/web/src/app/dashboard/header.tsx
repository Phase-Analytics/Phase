  ...
  const commandItems = useMemo<CommandItem[]>(() => {
    ...
    return [
      ...
      },
      {
        id: 'query',
        name: 'Query',
        description: 'Run read-only SQL against events, devices, and sessions',
        category: 'Analytics',
        icon: DatabaseIcon,
        keywords: ['query', 'sql', 'analytics', 'events', 'sessions'],
      ...
      },
      {
        ...
        category: 'Links',
        icon: Link01Icon,
        keywords: ['links', 'short', 'url', 'tracking'],
        path: `/dashboard/links?app=${appId}`,
      },
      {
        id: 'link-domains',
        name: 'Domains',
        description: 'Custom domains for short links',
        category: 'Links',
        icon: GlobalIcon,
        keywords: ['domains', 'cname', 'custom'],
