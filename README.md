<div align="center">
  <img src="./apps/web/public/favicon.svg" alt="Phase Analytics" width="100" height="100">
  <h1>Phase Analytics</h1>
  <p>Privacy-first mobile and web analytics platform</p>

  <p>
    <a href="https://phase.sh">Website</a> •
    <a href="https://phase.sh/docs">Documentation</a> •
...
![GitHub Repo stars](https://img.shields.io/github/stars/Phase-Analytics/Phase?style=flat&logo=github&label=Stars&labelColor=000000&color=ffffff)
![GitHub Release](https://img.shields.io/github/v/release/Phase-Analytics/Phase?style=flat&logo=git&label=Version&labelColor=000000&color=ffffff)
![GitHub License](https://img.shields.io/github/license/Phase-Analytics/Phase?label=License&labelColor=000000&color=ffffff)
...
For detailed privacy information, see our [Data Storage & Privacy Policy](https://phase.sh/docs/privacy/stored-data).

## Documentation

Complete documentation for integrating Phase Analytics into your applications:

**[View Full Documentation](https://phase.sh/docs)**
...
1. **Sign up** at [phase.sh](https://phase.sh)
2. **Create a project** and get your API key
3. **Install the SDK** for your platform
4. **Start tracking** events and sessions

For detailed installation and setup instructions, visit our [documentation](https://phase.sh/docs).
...
The GeoLite2 databases are distributed under the [Creative Commons Attribution-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-sa/4.0/)