...
const variants = [
    ...
    component: ({ className, ...props }) => (
      <button
        ...
        className={cn(
          ...
          'text-primary-foreground shadow-[var(--highlight-top-subtle)]',
          'hover:scale-[1.02] hover:border-primary/20 hover:bg-main-foreground/40',
          'active:scale-[0.98]',
          className
        )}
      />
  ...
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          'rounded-xl bg-linear-to-t from-green-700 to-green-600 px-4 py-2 text-white transition-all duration-200',
          'shadow-[var(--highlight-top),var(--shadow-sm)]',
          'hover:scale-[1.02] hover:from-green-600 hover:to-green-500 hover:shadow-[var(--highlight-top),var(--shadow-md)]',
          'active:scale-[0.98]',
          className
        )}
      />
  ...
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          'rounded-xl bg-linear-to-t from-red-600 to-red-500 px-4 py-2 text-white transition-all duration-200',
          'shadow-[var(--highlight-top),var(--shadow-sm)]',
          'hover:scale-[1.02] hover:from-red-500 hover:to-red-400 hover:shadow-[var(--highlight-top),var(--shadow-md)]',
          'active:scale-[0.98]',
          className
        )}
      />
  ...
  },
  {
    ...
    component: ({ children, className, ...props }) => (
      <button
        {...props}
        className={cn(
          'relative overflow-hidden rounded-xl border border-primary/10 bg-main-background px-4 py-2 text-primary-foreground transition-all duration-200',
          'shadow-[var(--highlight-top),var(--shadow-sm)]',
  ...
  },
  {
    ...
    component: ({ children, className, ...props }) => (
      <button
        {...props}
        className={cn(
          'relative rounded-xl border border-primary/10 bg-main-background px-4 py-2 transition-all duration-200',
          'shadow-[var(--highlight-top-subtle)]',
          'hover:scale-[1.02] hover:bg-main-foreground/40',
          'active:scale-[0.98]',
          className
        )}
      >
  ...
  },
  {
    ...
    component: ({ children, className, ...props }) => (
      <button
        {...props}
        className="relative inline-flex overflow-hidden rounded-xl p-px shadow-[var(--highlight-top-subtle)] transition-transform duration-200 hover:scale-[1.02] active:scale-[0.98]"
      >
        <span
          className={cn(
  ...
  },
  {
    ...
    component: ({ children: content, className, ...props }) => {
      ...
      return (
        <button
          {...props}
          className={cn(
            'group relative overflow-hidden rounded-xl px-4 py-2 text-primary-invert transition-all duration-200',
            'bg-primary/80 shadow-[var(--highlight-top),var(--shadow-sm)]',
            'hover:scale-[1.02] hover:bg-primary',
            'active:scale-[0.98] dark:hover:bg-primary',
            className
          )}
        >
          <TextGlitch>{content}</TextGlitch>
          <Brightness />
        </button>
      );
    },
